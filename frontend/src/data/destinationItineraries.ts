...
function journey({ slug, name, duration, route, price, summary, image }: JourneyDefinition, days: DayInput[]): Itinerary[] {
...
export const destinationItineraryLibrary: Record<string, Itinerary[]> = {
  dubai: journey({ slug: "dubai", name: "Dubai in Layers", duration: "5 Nights / 6 Days", route: "Old Dubai · Desert · Jumeirah", price: "₹62,000", summary: "A city-and-desert journey that balances landmark moments with the quieter side of the Emirates.", image: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  japan: journey({ slug: "japan", name: "Japan, in Detail", duration: "9 Nights / 10 Days", route: "Tokyo · Hakone · Kyoto", price: "₹1,46,000", summary: "A considered first journey through Japan, from Tokyo’s energy to Kyoto’s quieter rituals.", image: "https://images.unsplash.com/photo-1665706896821-319040b81753?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  switzerland: journey({ slug: "switzerland", name: "The Alpine Route", duration: "7 Nights / 8 Days", route: "Zurich · Lucerne · Interlaken · Montreux", price: "₹1,28,000", summary: "A scenic rail journey built around bright lakes, mountain air and beautifully timed pauses.", image: "https://images.unsplash.com/photo-1567250948107-98bf56ae6207?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  kashmir: journey({ slug: "kashmir", name: "The Valley, Gently", duration: "6 Nights / 7 Days", route: "Srinagar · Pahalgam · Gulmarg", price: "₹42,000", summary: "Houseboat mornings, cedar valleys and mountain days paced with room to breathe.", image: "https://images.unsplash.com/photo-1598091383021-15ddea10925d?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  kerala: journey({ slug: "kerala", name: "The Green & the Blue", duration: "5 Nights / 6 Days", route: "Kochi · Munnar · Kumarakom", price: "₹36,500", summary: "A gentle southern route from old port streets to tea hills and the backwaters.", image: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  rajasthan: journey({ slug: "rajasthan", name: "The Royal Route", duration: "7 Nights / 8 Days", route: "Jaipur · Jodhpur · Udaipur", price: "₹48,000", summary: "A richly textured route of forts, makers, blue lanes and beautifully hosted stays.", image: "https://images.unsplash.com/photo-1477587458883-47145ed94245?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  goa: journey({ slug: "goa", name: "Goa, Unhurried", duration: "4 Nights / 5 Days", route: "Panjim · South Goa", price: "₹29,500", summary: "Old lanes, thoughtful tables and enough coast time to forget what day it is.", image: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  thailand: journey({ slug: "thailand", name: "Thailand, in Full Colour", duration: "6 Nights / 7 Days", route: "Bangkok · Chiang Mai · Krabi", price: "₹52,000", summary: "A bright, generous route through market kitchens, northern craft and Andaman light.", image: "https://images.unsplash.com/photo-1508009603885-50cf7c579365?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  malaysia: journey({ slug: "malaysia", name: "Many Malaysias", duration: "6 Nights / 7 Days", route: "Kuala Lumpur · Penang · Langkawi", price: "₹49,500", summary: "A layered journey through city architecture, Penang kitchens and the island edge.", image: "https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  maldives: journey({ slug: "maldives", name: "The Blue Hour", duration: "5 Nights / 6 Days", route: "Malé · Private Island", price: "₹1,12,000", summary: "A private island pause where the day follows the water, light and your own appetite.", image: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  italy: journey({ slug: "italy", name: "The Italian Table", duration: "8 Nights / 9 Days", route: "Rome · Florence · Val d’Orcia", price: "₹1,34,000", summary: "Cities, villages and long lunches connected by rail and a love of making things well.", image: "https://images.unsplash.com/photo-1529260830199-42c24126f198?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  singapore: journey({ slug: "singapore", name: "A City in a Garden", duration: "4 Nights / 5 Days", route: "Civic District · Tiong Bahru · Sentosa", price: "₹46,500", summary: "A compact city break built around design, neighbourhood flavour and lush urban pauses.", image: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  "phu-quoc": journey({ slug: "phu-quoc", name: "The Quiet Island", duration: "5 Nights / 6 Days", route: "Duong Dong · Southern Coast", price: "₹44,000", summary: "A softer Vietnamese escape of fishing villages, warm water and unhurried seafood tables.", image: "https://images.unsplash.com/photo-1528127269322-539801943592?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  turkey: journey({ slug: "turkey", name: "Between Two Seas", duration: "8 Nights / 9 Days", route: "Istanbul · Cappadocia · Bodrum", price: "₹1,08,000", summary: "Ancient cities, generous tables and a bright Aegean finish connected with thoughtful private guiding.", image: "https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=1400&q=85" }, [
  ...
  australia: journey({ slug: "australia", name: "The Open Horizon", duration: "10 Nights / 11 Days", route: "Sydney · Uluru · Cairns", price: "₹1,78,000", summary: "A wide-open route from harbour life to red earth and the living colour of the reef.", image: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d0?auto=format&fit=crop&w=1400&q=85" }, [
